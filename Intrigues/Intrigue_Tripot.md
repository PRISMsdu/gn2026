# La Fuite des Margoulins — Intrigue de groupe

<!--
  DOCUMENT ORGA — groupe Tripot (casino du fort d’Ulghart).
  Récit joueurs collectif : `Groupes/Tripot/1 - Back de groupe/Back_groupe_Tripot.md`
  Fiches : `Groupes/Tripot/2 - Roles des Joueurs/`
  Croisements : [`Intrigue_Mafia.md`](Intrigue_Mafia.md), [`Intrigue_Banquiers.md`](Intrigue_Banquiers.md), [`Intrigue_Palyr.md`](Intrigue_Palyr.md), [`Intrigue_Il-Irion.md`](Intrigue_Il-Irion.md), [`Intrigue_Ther-Félis.md`](Intrigue_Ther-Félis.md), [`Intrigue_Sfaal.md`](Intrigue_Sfaal.md).
-->
...
Les **contacts Palyr** (refuge, logistique, contreparties) doivent être **officialisés en jeu** — aligner avec [`Intrigue_Palyr.md`](Intrigue_Palyr.md) quand disponible. Le fichier historique détaillé a été **fusionné** dans le document joueurs `Back_groupe_Tripot.md`.

**Triangle** : **Tripot** (flux, dettes, rumeurs) — **UBI** (coffres, artefact, transition) — **Mafia** (pression, rencontre régate). Le casino reste un **nœud social** : tout le monde passe, tout le monde parie.
...
- **Revenus casino** : tables, bar, nuitées d’élite, **paris régate**.
- **Ligne grise UBI** : 10 % historiques + **négociation** sur rétroactif ; **lettres** et **gages** dans `Contrats_et_Livres/` selon scènes.
- **Réserve de fuite** : comptes **parallèles** (Fenric tient une partie des **livres** — voir secret orga).

### Matériels

- **Salle**, **coffres**, **passages** — dont certains **non déclarés** à l’UBI.
- **Alchimie** (Soren) : potions, poisons, **feux** contrôlés.
- **Jeux** : tables truquées **à la marge** ; risque légal si preuve.
...
- **Dossiers VIP** : dettes, adultères, signatures — armes de **chantage**.
- **Rumeur artefact** : cohérent avec [`Intrigue_Banquiers.md`](Intrigue_Banquiers.md).
...
|--------------------|------------------|----------------------------|
| UBI / conseil sortant | Partenaire toxique | Blanchiment, contrat de gestion ; **Edorian** et ligne banque — [`Intrigue_Banquiers.md`](Intrigue_Banquiers.md), `Contrats_et_Livres/CORRESP-006.md`, `CORRESP-007.md`. |
...
| MiVI / Styrgie | Exploitation possible | Casino comme écoute — ne pas présumer d’alliance ; [`Intrigue_MiVI.md`](Intrigue_MiVI.md). |
| Juges régate | Levier | Cibles de **soudoiement** — coordonner avec autres groupes. |

*(L’ancien fichier `interactions_Tripot_vers_autres_groupes.csv` est fusionné ici. Vue **personnage Tripot → personnage autre groupe** : `Groupes/Tripot/interactions_Tripot_autres_groupes.csv`.)*
...
|-------------------|------|-------------|--------|--------|
| **Marda Velyss** | Patronne — stratégie & grands comptes | Négociation, magie de sceaux, pression banque | *selon table* | *à compléter* |
...
- **Ne pas** recopier dans `Back_groupe_Tripot.md` le détail exploitable.
- **Canon** : **Fenric Ossel** entretient une **piste de réserve** et des **écritures** non synchronisées avec Marda sur une fraction des flux — assurance personnelle ou trahison selon jeu ; si révélé en interne : crise de confiance au pire moment.
- Les **autres PJ** peuvent découvrir **en jeu** ; Marda peut être briefée MJ hors scène ou apprendre par indices.

### Documents additionnels

- `Contrats_et_Livres/CORRESP-007.md` — dette de salle (Marda / Sangs)
- `Contrats_et_Livres/CORRESP-006.md` — bordereau interne UBI
- `Groupes/Tripot/1 - Back de groupe/Back_groupe_Tripot.md`
- `Groupes/Tripot/2 - Roles des Joueurs/`

### Culture et dynamique interne

- **Famille de circonstance** : seuls les **idiots** croient à la loyauté sans **contrat** ; ici le contrat, c’est **l’or** et le **silence**.
- **Sœurs Vestrann** : complémentarité ou rivalité — tension jouable.
- **Oracle** : les visions peuvent être **vraies** ou **utiles** — MJ arbitre les infos données par tirage / orga. **Lydwen** est le seul PJ (hors **Soren**) briefé avec le **lien Brigade** au départ si l’orga le joue par les cartes.

---

## Secrets et informations sensibles

- **Artefact maudit** (UBI) : le groupe croit tenir une **carte** que les banquiers **ne savent pas** qu’ils ont montrée ; usage : **chantage** ou **vente** — ne pas casser l’intrigue banque sans accord MJ banque.
- **Blanchiment 10 % → 15 %** : preuve comptable dispersée ; **Fenric** sait où ; Marda **pense** tout voir.
