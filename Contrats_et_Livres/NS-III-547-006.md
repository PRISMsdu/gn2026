...
- Date : 12 du mois de Simivisonios de l'an cinq cent quarante-sept
...
2. **UBI** — Passation conseil : nominations compatibles avec le rapprochement **Arthas / Ther-Félis** ; en parallèle localiser ou neutraliser les preuves de **guerre** contre la République (archives, correspondances).
...
*Registre UBI : **NS-III-547-006** — `Registre_UBI_Orga.md`.*
