...
| **Point de rendez-vous** | Quai **B** — avant-poste lanterne **jaune** (troisième nuit de régate) | Contact transitoire délégué Arthas | Voir aussi `Intrigues/Délégation Arthas.md` pour le contexte dépôts UBI. |
...
*Registre UBI : **AN-III-547-008** — `Registre_UBI_Orga.md`.*
