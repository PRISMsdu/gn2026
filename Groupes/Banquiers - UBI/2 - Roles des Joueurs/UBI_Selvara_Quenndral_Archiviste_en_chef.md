...
| Élément | Description |
|---------|-------------|
| Traits de caractère | Précise, économe en mots, méfiance structurelle envers ceux qui ne lisent pas les textes avant de signer. |
| Valeurs | La rigueur du document comme seule protection durable. Ce qui n'est pas écrit correctement peut être retourné contre toi. |
| Peur | Qu'un auditeur reconstitue la séquence des falsifications. Que ses copies secrètes soient découvertes avant qu'elle soit partie. |
| Rêve | Retrouver une position d'influence dans les cercles érudits, avec assez de documents compromettants pour n'avoir plus jamais à obéir à personne. |
...
Cette réputation s'effondre en quelques années. Ton père accepte une mission pour une maison de Sfaal et certifie l'authenticité d'un sceau qui se révèle être un faux. Volontaire ou non, la question ne se pose pas : la maison le poursuit en justice. Le procès dure trois ans. À l'issue, ta famille n'a plus ni argent, ni clients, ni maison.

Tu as vingt ans quand le procès se termine. Tu n'as pas attendu la fin pour partir. Tu t'es installée à Il-Irion à dix-huit ans, sans lettre de recommandation, sans relations, avec une mémoire exceptionnelle et la capacité de lire n'importe quel acte en moins d'une heure.

## Chapitre II : L'apprentissage

Tu trouves un poste de copiste dans une maison d'archives à Il-Irion. Le travail est répétitif mais précis : recopier des actes, vérifier des sceaux, classer des registres par date et par cité d'origine. Tu ne fais pas d'erreurs. En six mois tu es promue à un poste de vérification des actes entrants.

Tu apprends très vite que les archives sont une ressource. Ce qui y entre y reste. Et ce qui y reste peut sortir si on sait comment. Tu commences à faire des copies discrètes de documents que tu juges utiles pour toi : correspondances de familles nobles, clauses d'accords commerciaux, conditions de prêts que les signataires auraient préféré garder privées.

Tu ne vends rien. Tu constitues un capital. Tu le gardes pour le moment où tu en auras besoin. Ce moment n'est pas encore venu.

## Chapitre III : L'ascension

Sfaal veut un siège à l'UBI. Edorian aide Sfaal à choisir son candidat. Ton dossier est solide : compétences en archivistique, réseau discret à Il-Irion, réputation de précision. Edorian connaît aussi l'usage que tu fais de certains documents. Il te contacte avant la nomination. Il te dit ce qu'il prépare. Il te propose une place dans le plan en échange d'un travail précis : rédiger les actes qui donnent une apparence légale aux opérations hors registre, et maintenir des registres officiels cohérents avec ces actes.
...
Melian signe les bénédictions sur les actes que tu rédiges. Il sait que certains de ces actes couvrent des opérations qui ne correspondent pas à ce que le dogme de son ordre appelle légitime. Tu ne lui demandes pas de comprendre les chiffres. Tu lui demandes de signer là où c'est indiqué.
