# Groupe Banquiers — Union bancaire d’Il-Irion (UBI)

## Effectif

**9 joueurs** — personnages listés dans le back collectif et les fiches individuelles.
...
Avis publics (affichables en salle) : `1 - Back de groupe/Avis_depot_or_UBI.md` (or), `Avis_depot_documents_UBI.md` (écrits, criticité), `Avis_depot_biens_UBI.md` (objets, matières, ingrédients magiques, catégorie de garde).
