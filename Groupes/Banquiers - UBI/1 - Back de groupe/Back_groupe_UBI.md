# L'or sous le sceau — Chronique de l'Union bancaire d'Il-Irion
...
Vous êtes neuf. Vous partagez le même fort depuis cinq ans. Le mandat se termine le week-end de la Régate. Un **nouveau conseil** prend la suite. Ce document dit comment vous en êtes arrivés là, ce que vous avez traversé ensemble, et dans quel état vous vous trouvez aujourd'hui.

---

## I — La nomination, il y a cinq ans

Il y a cinq ans, le conseil précédent est arrivé au terme de son mandat sans incident majeur. La tradition confédérale veut que les **cinq cités** se mettent d'accord sur un nouveau conseil exécutif de cinq conseillers — un par cité. Le mécanisme de désignation passe par la **grande Régate** : dans l'ordre de classement des équipages, chaque cité revendique le poste qu'elle convoite pour son candidat. La cité qui finit première choisit en premier ; la dernière prend ce qui reste. Ce système force les négociations en amont — aucune cité ne sait avec certitude quel rang elle obtiendra, et les alliances entre équipages se nouent aussi en fonction des postes visés à l'UBI.
...
**Selvara Quenndral** tient les archives, les textes légaux et les scellés inter-cités, placée par **Sfaal**. Son rôle est de rédiger ou valider les actes engageant plusieurs cités, de gérer les versions contradictoires d'un même scellé, et de s'assurer que ce que dit le registre peut tenir debout devant un auditeur.

**Horgrim Dval** est chef de la garde, nommé par **Ther-Félis**. Il contrôle l'accès aux zones sensibles, supervise les gardes, et décide des procédures d'entrée dans les réserves. Ther-Félis voulait une présence physique dans la forteresse ; Horgrim est un soldat, pas un politique, et ça convient aux quatre autres — un chef de garde qui fait son travail sans chercher à comprendre les arbitrages du bureau.

Ce que la version officielle ne dit pas : **Edorian a piloté l'ensemble des nominations**. Chaque cité croyait placer son propre candidat. Dans les faits, les dossiers, les contacts et les pressions qui ont conduit chaque délégation à choisir le bon nom avaient été préparés en amont par Edorian et son réseau. Le résultat : un conseil de cinq membres dont chacun sait qu'il est là parce qu'Edorian l'a voulu — et chacun sait que les quatre autres le savent aussi.

---

## II — Ce que le mandat a produit
...
Une partie des flux hors registre a transité par le **Tripot** — le casino installé dans le fort. Le lien entre la banque et le casino était connu du public et toléré par la Confédération depuis des années ; ce que le public ne voit pas, c'est précisément l'usage qui en a été fait pendant ce mandat. **Marda Velyss** dirige le Tripot ; elle sait ce qu'elle a géré.

Dans une institution de cette taille, personne ne traverse cinq ans sans voir quelque chose ou sans qu'on lui demande quelque chose.
...
**Corvus** tient la chaîne des clés depuis cinq ans. Il a ouvert et fermé les salles des coffres selon les ordres qu'il recevait, en appliquant les procédures. Il a vu défiler des mouvements. Il a choisi ce qu'il notait et ce qu'il ne notait pas. La passation, pour lui, signifie un nouveau gardien des coffres et un inventaire complet. Ce que cet inventaire révélera dépend de ce qu'il reste à trouver.

---

## III — La situation aujourd'hui

**Edorian** a un plan. Il l'a construit depuis plusieurs mois, en coordination avec les autres membres du conseil. En surface, ce plan ressemble à une passation ordinaire : le mandat sortant remet les clés dans les règles, les registres sont prêts, les actes en cours sont soldés. Le nouveau conseil arrive, tout est en ordre.
...
## Annexe — Ce que dit la charte

Les textes fondateurs de l'Union parlent de **neutralité**, d'**inviolabilité des dépôts**, et du **rôle du conseil**. Tout citoyen instruit de la Confédération peut citer ces principes. Dans les faits, la charte sert aussi de **prétexte** pour refuser une inspection, et d'**argument** pour un adversaire qui veut prouver un manquement.

---

## Annexe — Mécanisme de la banque (dépôt d'or)

**Rappel** : présentation et pesée ont lieu **au comptoir** ; la pesée se fait **à l'écart** du passage (file, paravent, alcôve). Ensuite acte, paiement des droits, puis descente vers les coffres selon la procédure d'accès.

### Fil courant — rôles directs dans l'ordre des étapes

| Étape | Rôles directs |
|-------|----------------|
| **Première porte — la garde** | **Horgrim** : consignes d'entrée, armes, chemins ; refus ou retard possibles. |
| **Comptoir — parole et balance à l'écart** | **Ydria** : accueil du dépôt, pesée à l'écart, valeur retenue, annonce de ce que coûte la garde pour la période. |
| **Acte et trace** | **Ydria** : signature habituelle de l'engagement. |
| **La monnaie de la garde** | **Ydria** : encaissement avant ouverture du coffre de dépôt. |
| **Coffres** | **Corvus** : chaîne des clés, dépôt physique, scellement. **Horgrim** : ordre d'accès aux zones sensibles si la maison l'exige. |


---

## Annexe — Mécanisme de la banque (dépôt de documents)

**Rappel** : la **valeur** de la garde ne vient pas de l'or pesé : elle vient de la **criticité** retenue au comptoir (ce qu'une fuite coûterait au déposant et à la maison). Présentation et examen à l'écart ont lieu **au comptoir** ; l'acte ne doit **pas recopier** le texte déposé — seule la trace, la criticité et les droits entrent dans le registre.
...
|-------|----------------|
| **Première porte — la garde** | **Horgrim** : consignes d'entrée, armes, chemins ; refus ou retard possibles. |
| **Comptoir — parole et examen à l'écart** | **Selvara** : accueil du dépôt, annonce des **droits** une fois la criticité fixée, identification des sceaux, du titre ou du volume **sans** lecture publique du contenu. |
| **Acte et trace** | **Selvara** : signature habituelle de l'engagement. |
| **La monnaie de la garde** | **Ydria** : encaissement avant remise au lieu clos. |
| **Coffres et armoires** | **Corvus** : chaîne des clés, remise en chambre close ou armoire scellée, scellement. **Horgrim** : ordre d'accès aux zones sensibles si la maison l'exige. |



## Annexe — Mécanisme de la banque (dépôt de biens et ingrédients)

**Rappel** : la **catégorie de garde** regroupe volume, fragilité, danger pour les personnes ou le bâtiment, et charge magique pour ingrédients ou objets imprégnés. Présentation et examen à l'écart ont lieu **au comptoir** ; l'acte repose sur une **description** et des **interditions** convenues, pas sur une expertise magique complète sauf accord.

### Fil courant — rôles directs dans l'ordre des étapes

| Étape | Rôles directs |
|-------|----------------|
| **Première porte — la garde** | **Horgrim** : consignes d'entrée, armes, chemins ; parcours renforcé si le bien l'exige ; refus ou retard possibles. |
| **Comptoir — parole et examen à l'écart** | **Melian** : accueil, accord sur la **catégorie de garde** et annonce des **droits**. **Selvara** : description inscrite, nature déclarée (objet, matière, ingrédient magique, etc.) et cohérence avec le registre. |
| **Acte et trace** | **Melian** : signature habituelle de l'engagement. **Selvara** : formulaire, sceau, reconnaissance et ligne au registre. |
| **La monnaie de la garde** | **Ydria** : encaissement avant conduite du bien vers son lieu de dépôt. |
| **Coffres et salles adaptées** | **Corvus** : chaîne des clés, choix du lieu (coffre, salle, cercle ou précautions d'usage), scellement ou **cernage** selon la procédure. **Horgrim** : ordre d'accès et sécurisation des zones sensibles. |
