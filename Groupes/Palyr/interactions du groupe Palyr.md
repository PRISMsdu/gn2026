# Interactions du groupe — Palyr

<!--
  Note outil (scénaristes) : synthèse de consolidation ; alignement Intrigue / backs perso ; périmètre « autres groupes seulement » : voir `Groupes/Afaire.md`, *Check d’un groupe*.
-->

Chaque ligne rappelle un **croisement possible à Ulghart** entre ton personnage (Palyr) et un **interlocuteur d’une autre cité ou d’un autre réseau**. Ce qui se joue **entre vous**, dans la délégation, n’apparaît pas ici.

| Personnage du groupe (Palyr) | Personnage en interaction | Descriptif rapide (2–3 lignes) |
|---|---|---|
