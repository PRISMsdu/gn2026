...
| Nom | Rôle | En bref |
|-----|------|---------|
| **Kaelan Thormane** | Chef de famille | Grandes décisions ; interface avec la ligne Elfrion / MiVI |
| **Vorak Ironhand** | Second / coordinateur | Opérations majeures, cellules, relais |
| **Gareth Ironfist** | Homme de main | Intimidation, protection, règlements |
