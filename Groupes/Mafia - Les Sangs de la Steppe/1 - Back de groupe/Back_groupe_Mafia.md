...
<!--
  ...
  Chaîne : `Intrigues/Intrigue_Mafia.md` (orga) → ce fichier → `Groupes/Mafia - Les Sangs de la Steppe/2 - Roles des Joueurs/Mafia_*_*.md` (nom du personnage + rôle dans la famille).
-->
