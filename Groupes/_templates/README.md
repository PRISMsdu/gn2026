...
| **3** | `Groupes/[Groupe]/3 - Roles des Joueurs/role_joueur_*.md` | **Chaque joueur** | Fiche individuelle : pratique GN, portrait, histoire courte, missions, contacts, informations sensibles du perso. Gabarit : `2 - Roles de groupe/template_role_joueur.md`. |
...
## Travail intermédiaire MJ (optionnel)

Certains groupes conservent encore des brouillons `perso_*-orga.md` ou équivalent ; la cible de publication est **`2 - Roles des Joueurs/role_joueur_*.md`** selon `template_role_joueur.md`, après le **Back_groupe** et l’intrigue.
