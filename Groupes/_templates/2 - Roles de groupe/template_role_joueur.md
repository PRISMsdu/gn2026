# [NOM_DU_PERSONNAGE] — [Rôle / titre]

<!--
  TEMPLATE — Rôle joueur individuel (étape 3 du workflow).
  Sources rédaction : intrigue MJ, back de groupe orga, backs perso orga si présents (hors livret joueur).
