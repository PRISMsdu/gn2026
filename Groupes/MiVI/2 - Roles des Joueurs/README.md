...
Fiches individuelles remises à chaque joueur. Convention de nommage : `MiVI_NomDuPersonnage_RoleDansLeGroupe.md`.

Référence rôles et stats : `Groupes/MiVI/1 - Back de groupe/Competence_MiVI.csv`.
...
L'identité Questeur est empruntée depuis deux jours, après l'embuscade de la vraie escorte.
