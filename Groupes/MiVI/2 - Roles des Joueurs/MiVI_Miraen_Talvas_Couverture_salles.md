# Miraen Talvas — Couverture salles / interface Tripot
...
| Remarques | Dernier mot sur ce qui se joue à la lumière des chandeliers ; secret personnel : voir « Connaissances » — les autres PJ ne sont pas briefés dans le back commun. |
| Doublons (or) | 100 |
| Pugilat | 3 |
...
| Rêve | Sortir d'Ulghart avec la mission tenue et un nom encore maîtrisable. |

---

# L'histoire de Miraen Talvas

## Chapitre I : Les origines (tables)

Tu es entré par la grande porte des casinos avant d'entrer par la petite porte du service. Le bruit des jetons ne te berce pas : il te donne le tempo. Tu sais où t'asseoir pour qu'on te lise comme un habitué, pas comme un fonctionnaire. Tu sais quelles mains les croupiers surveillent en premier. Tu as appris tôt que l'or est le dernier mot seulement pour les naïfs : les dettes utiles se signent en faveurs, en regards, en rendez-vous qu'on ne peut pas refuser sans perdre la chaise.
...
Première simulation : trop de bruit, échec. Deuxième : sirène trop tôt, faux Il-Rion. Tu as feint la panique là où il fallait détourner les yeux. Pas du théâtre gratuit : des secondes achetées pour que la chaîne tienne. Tu te souviens du goût métallique quand les cris ont monté. Ce goût revient quand une salle d'Ulghart applaudit trop fort.

## Chapitre IV : Les défis actuels (Tripot et île)

Le détachement vient pour des comptes durs : fer détourné, Tripot qui résiste, levier UBI que les chefs des Sangs n'ont pas livré assez net, routes à faire pencher sans déclencher l'embargo qui rallierait toute la Confédération contre la République. Ton terrain est le Tripot : Varek et la grille des contacts, Marda et les dettes historiques des Sangs, tables VIP, protecteurs maison, paris d'élite.

Tu dois tenir une couverture assez solide pour que le MiVI lise et pousse sans y entrer comme une invasion de caserne. Tu dois recouper chaque rumeur de salle avec Ysel et Théven : une rumeur n'est pas une preuve. Tu dois offrir des rencontres forcées utiles — régate, couloirs, dettes croisées — sans devenir toi-même la faille qui livre la Styrgie sur un plateau aux rivaux confédéraux.

Varek et sa grille : couloir bouteilles, dé à coudre bleu, créneaux à ne pas croiser avec d'autres initiales le même jour — ce ne sont pas des détails de roman, ce sont des points de rendez-vous où une erreur te coupe l'accès. Marda et la dette historique des Sangs : tu y entres comme on entre dans un courant, en sachant où est la rive. Éliane et les paris d'élite te donnent des tables VIP où l'on parle trop quand on croit gagner. Ardan Trevil et le muscle maison : tu le respectes comme une limite physique, pas comme une opinion. Chaque main gagnée sans recoupement est une dette future pour la mission.
...
- **Tenir une couverture crédible** au Tripot : tables, codes, visages — pour que le détachement y lise et y agisse sans passer pour une invasion.
